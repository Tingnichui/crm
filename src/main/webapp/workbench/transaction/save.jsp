...
<body>
	...
	<form action="workbench/transaction/save.do" id="tranForm" method="post" class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control downtime" id="create-expectedClosingDate" name="expectedDate">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-activitySrc" value="拉屎吗？兄弟">
				<input type="hidden" name="activityId" value="513e62c02f4f416c9f4e4b31c4bb5db8">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-contactsName" value="耿辉">
				<input type="hidden" name="contactsId" value="2e5fb4311cd6472ca9d7e04c16a87988">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control uptime" id="create-nextContactTime" name="nextContactTime">
			</div>
		</div>
