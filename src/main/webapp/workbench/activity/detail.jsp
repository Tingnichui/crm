...
<script type="text/javascript">
	...
	//	页面加载完毕后局部刷新备注
			...
			$.ajax({
				...
				//	data{"success":success,“ar”：ar}
					if (data.success){
						...
						html += '<h5 id="edit'+data.ar.id+'">'+data.ar.noteContent+'</h5>'
        ...
        $("#updateRemarkBtn").click(function (){
            ...
            $.ajax({
                url : "workbench/activity/updateRemarkById.do",
                data : {
                    "id":id,
                ...
                dataType : "json",
                success : function (data){
                    //data{"success":succesee,"ar":ar}
                    if (data.success){
                        $("#edit"+id).html(data.ar.noteContent)
                        $("#s"+id).html(data.ar.editTime +"you"+ data.ar.editBy)
	...
	function editRemark(id){
        $("#edit-noteContent").val($("#edit"+id).html())
        $("#remarkId").val(id)
